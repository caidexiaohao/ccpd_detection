...
train_folder = r'recognition\images\train'
train_label_folder = r'recognition\labels\train'
val_folder = r'recognition\images\val'
val_label_folder = r'recognition\labels\val'
...
class LicensePlateDataset(Dataset):
    def __init__(self, image_folder, label_folder, vocab, max_length=16, transform=None):
...
if __name__ == "__main__":
    ...
    train_dataset = LicensePlateDataset(train_folder, train_label_folder, vocab, max_length, transform)
